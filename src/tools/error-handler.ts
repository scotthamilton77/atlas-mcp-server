...
export function createToolError(
  ...
  return createError(code, message, `ToolHandler.${operation}`, userMessage, metadata);
}
...
export class ToolErrorHandler {
   ...
   */
  handleToolNotFound(toolName: string, context?: Record<string, unknown>): never {
   ...
   */
  handleTimeout(toolName: string, duration: number, context?: Record<string, unknown>): never {
